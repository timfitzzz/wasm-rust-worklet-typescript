...
(function (window) {
    ...
    ? typeof global == "" + void 0
        ...
        : global
    : globalThis);
define("src/PitchProcessor", ["require", "exports", "../public/wasm-tuner/wasm_tuner", "requirejs", "../public/TextEncoder.js"], function (require, exports, wasm_tuner_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    wasm_tuner_1 = __importStar(wasm_tuner_1);
        ...
        function PitchProcessor() {
            ...
            _this.onmessage = function (event) {
                if (event.type === 'send-wasm-module') {
                    ...
                    wasm_tuner_1.default(WebAssembly.compile(event.wasmBytes)).then(function () {
                    ...
                    _this.detector = wasm_tuner_1.WasmPitchDetector.new(sampleRate, sampleCount);
                    // create input buffer
